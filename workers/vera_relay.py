...
def _check_summit_deadline():
    ...
    msg = (
        ...
        f'>All 152+ commercial segments (restaurants, banks, gyms, hospitals, sports venues + more) miss peak season.\n'
...
def _check_june8_geauga_portage():
    ...
    msg = (
        ...
        f'>All 152+ commercial segments fire here: hospitals (Cleveland Clinic, UH, MetroHealth), museums\n'
        ...
        f'> ✅ Title + org keyword batching active (Run 134+): all 152+ segments fully queried.\n'
        f'>{note}\n'
...
def _check_july20_cuyahoga_2():
    ...
    msg = (
        ...
        f'>Highest-volume market — all 152+ commercial segments at max capacity.\n'
        f'>{note}\n'
        f'>Command: `cd /Users/bradleyneal/forestcity && python3 workers/lead_pipeline.py both Cuyahoga`'
    )
    if post_slack(msg):
...
def _check_early_cuyahoga_opportunity():
    ...
    152+ commercial segments won't get Cuyahoga contacts until the scheduled June 8 pull.
    ...
    msg = (
        ...
        f'>152+ commercial segments (hospital campuses, municipal facilities, DSO dental groups, YMCA branches,\n'
...
def _check_post_june8_commercial_monitoring():
    ...
    msg = (
        ...
        f'>The June 8 Cuyahoga pull enrolled the largest commercial batch of the season (152+ segments).\n'
...
def _check_june9_cuyahoga_verification():
    ...
    June 8 = 152+ segments, largest single-day commercial pull of peak season. One-time, self-deactivating.
    ...
    if danny_ran and carla_ran:
        msg = (
            ...
            '>All 152+ commercial segments enrolled. First opens expected June 11–13 (Touch 1 Day 0 → opens by Day 3).\n'
        ...
        msg = (
            ...
            '>152+ commercial segments. Missing this = no hospital/DSO/government/museum contacts for the entire season.\n'
