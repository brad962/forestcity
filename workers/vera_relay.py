...
def _check_summit_deadline():
    ...
    msg = (
        ...
        f'>All 196+ commercial segments (restaurants, banks, gyms, hospitals, sports venues + more) miss peak season.\n'
...
def _check_past_customer_blast():
    """Fire daily May 27–July 31: past customers are the fastest, cheapest revenue path all season.
    Extended from June 7 → July 31 (Run 192): ads-learning-phase framing was accurate May-June but
    past customer outreach is evergreen high-ROI throughout all of peak season.
    Tommy wrote the guide May 27. Self-deactivates August 1."""
    from datetime import date as _date_pc
    today = _date_pc.today()
    start = _date_pc(2026, 5, 27)
    end   = _date_pc(2026, 7, 31)
    if not (start <= today <= end):
        return
    ...
    msg = (
        '💰 *Past Customer Blast — Fastest Revenue Right Now*\n'
        '>Past customers book 3–5× faster than cold leads — they already trust you.\n'
...
def _check_june8_geauga_portage():
    ...
    msg = (
        ...
        f'>All 196+ commercial segments fire here: hospitals (Cleveland Clinic, UH, MetroHealth), museums\n'
        ...
        f'> ✅ Title + org keyword batching active (Run 134+): all 196+ segments fully queried.\n'
        f'>{note}\n'
...
def _check_july20_cuyahoga_2():
    ...
    msg = (
        ...
        f'>Highest-volume market — all 196+ commercial segments at max capacity.\n'
        f'>{note}\n'
        f'>Command: `cd /Users/bradleyneal/forestcity && python3 workers/lead_pipeline.py both Cuyahoga`'
    )
    if post_slack(msg):
...
def _check_early_cuyahoga_opportunity():
    ...
    196+ commercial segments won't get Cuyahoga contacts until the scheduled June 8 pull.
    ...
    msg = (
        ...
        f'>196+ commercial segments (hospital campuses, municipal facilities, DSO dental groups, YMCA branches,\n'
...
def _check_post_june8_commercial_monitoring():
    ...
    msg = (
        ...
        f'>The June 8 Cuyahoga pull enrolled the largest commercial batch of the season (192+ segments).\n'
...
def _check_june9_cuyahoga_verification():
    ...
    June 8 = 192+ segments, largest single-day commercial pull of peak season. One-time, self-deactivating.
    ...
    if danny_ran and carla_ran:
        msg = (
            ...
            '>All 196+ commercial segments enrolled. First opens expected June 11–13 (Touch 1 Day 0 → opens by Day 3).\n'
        ...
        msg = (
            ...
            '>196+ commercial segments. Missing this = no hospital/DSO/government/museum contacts for the entire season.\n'
